...
import {
  getRecentNotes,
  type RecentNote,
} from "@/lib/actions/get-recent-notes";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        />
        <path
          d="M37.5 67.5 Q37.5 55 50 55 L112.5 55 Q122.5 55 127.5 65 L137.5 77.5 L212.5 77.5 Q225 77.5 225 87.5 L225 160 Q225 160 212.5 160 L50 160 Q37.5 160 37.5 147.5 Z"
          fill="#7C3AED"
        />
        {/* Paper */}
        <rect
        ...
        {/* Sparkles */}
        <text x="35" y="82.5" fontSize="18.75" fill="#FBBF24">
          ✦
        </text>
        <text x="187.5" y="55" fontSize="12.5" fill="#FBBF24">
          ✦
        </text>
        <text x="200" y="117.5" fontSize="10" fill="#C4B5FD">
          ✦
        </text>
        <text x="47.5" y="147.5" fontSize="8.75" fill="#C4B5FD">
          ✦
        </text>
      </svg>
      {/* Floating mini cards */}
...
function getFileTypeLabel(note: RecentNote) {
  const titleExtension = note.title.split(".").pop()?.toLowerCase();

  if (titleExtension === "png") {
    return "png";
  }

  if (titleExtension === "jpg" || titleExtension === "jpeg") {
...
function getQuestionCount(note: RecentNote) {
    ...
    <main className="main-container font-jakarta">
      <div className="max-w-350 mx-auto">
            ...
            <div className="hero-badges">
              {[
                ...
                <div key={label} className="hero-badge-item">
                  <div className="hero-badge-icon">{icon}</div>
                  {label}
                </div>
              ))}
            </div>
        ...
        <div className="section-container">
                  ...
                  return (
                    <TableRow key={note._id} className="table-row">
                      ...
                      <TableCell className="table-cell-py px-table w-10">
                        <div className={`table-file-icon ${color}`}>
          ...
          {/* View all */}
          <Link href="/dashboard/notes" className="table-view-all">
            View all notes
